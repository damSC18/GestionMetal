...
public class InterfazPresupuesto: Application() {


    override fun start(stage: Stage) {

        val root : Parent = FXMLLoader.load(javaClass.getResource("presupuesto.fxml"))
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            launch(InterfazPresupuesto::class.java)
        }
    }
}
