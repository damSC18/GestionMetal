...
public class listadoArticulosFabricados() {
    var stmt: Statement? = null
    var connection: Connection? = null

    fun imprimefichero() {
      //   var rutareporte = System.getProperty("user.dir") + "\\LitsadoProductosFabricados.jrxml"
        var rutareporte = System.getProperty("user.dir") + "\\LitsadoProductosFabricados.jasper"
...
// Se utiliza si lo hacemos con el fichero sin comipla jrxml en lugar de jasper
    //  var jasperReport: JasperReport = JasperCompileManager.compileReport(rutareporte)//l3.jrxml");
        ...
        parameters.put("codigoFamilia", 3)
        // DataSource
      ...
      //  var jasperPrint: JasperPrint = JasperFillManager.fillReport(jasperReport, parameters, connection);
        ...
        var rutaPdf = System.getProperty("user.dir") + "\\listadoArticulosFabricados.PDF"
...
fun main(param: Array<String>) {
  ...
  //  listadoArticulosFabricados.imprimefichero()
