...
public class InterfazProductosFabricados: Application() {


    override fun start(stage: Stage) {

        val root : Parent = FXMLLoader.load(javaClass.getResource("ProductosFabricados.fxml"))
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            launch(InterfazProductosFabricados::class.java)
        }
    }
}
